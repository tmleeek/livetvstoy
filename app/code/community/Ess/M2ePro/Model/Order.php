...
class Ess_M2ePro_Model_Order extends Ess_M2ePro_Model_Component_Parent_Abstract
{
    ...
    {
        try {
 Mage::log('createMagentoOrder', null, 'amazon_custom.log');
            ...
            if (empty($magentoOrderId)) {
                ...
                Mage::log('Magento Order id null:'.$this->magentoOrder->getId(), null, 'amazon_custom.log');
                $this->save();
            }
    ...
    public function afterCreateMagentoOrder()
    {
        ...
        //$magentoOrderUpdater->amazon_custom($this->getMagentoOrderId());
        $magentoOrderUpdater->finishUpdate();        
        // ---------------------------------------

        Mage::dispatchEvent('m2epro_order_place_success', array('order' => $this));
Mage::log('afterCreateMagentoOrder'.$this->getMagentoOrder()->getRealOrderId(), null, 'amazon_custom.log');
