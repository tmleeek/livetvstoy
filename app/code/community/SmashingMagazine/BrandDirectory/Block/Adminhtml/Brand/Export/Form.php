<?php
class SmashingMagazine_BrandDirectory_Block_Adminhtml_Brand_Export_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $form = new Varien_Data_Form(array(
            'id' => 'edit_form',
            'action' => $this->getUrl(
                'smashingmagazine_branddirectory_admin/brand/exportfile', 
                array(
                    '_current' => true,
                    'continue' => 0,
                )
