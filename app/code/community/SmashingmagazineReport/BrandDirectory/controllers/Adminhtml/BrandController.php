<?php
class SmashingmagazineReport_BrandDirectory_Adminhtml_BrandController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $brandBlock = $this->getLayout()
            ->createBlock('smashingmagazinereport_branddirectory_adminhtml/brand');
    ...
    public function editAction()
    {
         ...
         */
        $brand = Mage::getModel('smashingmagazinereport_branddirectory/brand');
        if ($brandId = $this->getRequest()->getParam('id', false)) {
            ...
            if ($brand->getId() < 1) {
                ...
                return $this->_redirect(
                    'smashingmagazinereport_branddirectory_admin/brand/index'
                );
            }
        }
        ...
        $brandEditBlock = $this->getLayout()->createBlock(
            'smashingmagazinereport_branddirectory_adminhtml/brand_edit'
        );
        ...
        switch ($actionName) {
            ...
            default:
                ...
                $isAllowed = $adminSession
                    ->isAllowed('smashingmagazinereport_branddirectory/brand');
                break;
        }
    ...
    public function exportCsvAction()
{
    ...
    $content    = $this->getLayout()->createBlock('smashingmagazinereport_branddirectory_adminhtml/brand_grid')
    ->getCsvFile();
