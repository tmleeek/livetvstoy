<?php
class SmashingmagazineReport_BrandDirectory_Model_Resource_Brand
    extends Mage_Core_Model_Resource_Db_Abstract
{
    protected function _construct()
    {
         ...
         * 
         * In this example:
         * - smashingmagazinereport_branddirectory is the Model alias
         ...
         * 'smashingmagazinereport_branddirectory_brand' and any calls to 
         * $model->getId() will retrieve the data from the column 
         * named 'entity_id'.
         */
        $this->_init('smashingmagazinereport_branddirectory/brand', 'id');
    }
}