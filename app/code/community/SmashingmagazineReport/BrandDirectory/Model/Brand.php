<?php
class SmashingmagazineReport_BrandDirectory_Model_Brand
    extends Mage_Core_Model_Abstract
{
    ...
    protected function _construct()
    {
         ...
         * in this case 'smashingmagazinereport_branddirectory' and look in 
         ...
         * SmashingmagazineReport_BrandDirectory_Model_Resource
         */
        $this->_init('smashingmagazinereport_branddirectory/brand');
    }
    ...
    public function getAvailableVisibilies()
    {
        return array(
            self::VISIBILITY_HIDDEN 
                => Mage::helper('smashingmagazinereport_branddirectory')
                       ->__('Hidden'),
