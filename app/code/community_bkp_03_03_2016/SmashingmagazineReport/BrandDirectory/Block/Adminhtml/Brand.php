<?php
class SmashingmagazineReport_BrandDirectory_Block_Adminhtml_Brand
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
         ...
         */
        $this->_blockGroup = 'smashingmagazinereport_branddirectory_adminhtml';
         ...
         */
        $this->_headerText = Mage::helper('smashingmagazinereport_branddirectory')
            ->__('Sitelink Transaction Report');
    }
