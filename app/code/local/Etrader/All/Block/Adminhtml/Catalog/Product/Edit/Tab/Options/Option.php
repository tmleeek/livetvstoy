...
class Etrader_All_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
	public function __construct()
    {
        parent::__construct();
        $this->setTemplate('etrader/catalog/product/edit/options/option.phtml');
...
//        $optionsArr = $this->getProduct()->getOptions();
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
				...
				$value['class_code'] = $option->getClassCode();
                $value['enable'] = $option->getEnable();
...
//                    $valuesArr = array_reverse($option->getValues(), true);
                    ...
                    foreach ($option->getValues() as $_value) {
                        ...
                        $value['optionValues'][$i] = array(
							...
							'class_code' => $_value->getClassCode(),
                        );
