 ...
 */
class CRM4Ecommerce_AdminStartupPage_Block_Rewrite_Permissions_User_Edit_Tab_Main extends Mage_Adminhtml_Block_Permissions_User_Edit_Tab_Main {
    ...
    protected function _prepareForm() {
        ...
        if (Mage::getStoreConfig('crm4ecommerce_adminstartuppage/general/status') == CRM4Ecommerce_CRMCore_Model_Option_ModuleStatus::STATUS_ENABLED
            ...
            $fieldset->addField('crm4e_startup_page', 'select', array(
                ...
                'values' => Mage::getModel('adminhtml/system_config_source_admin_page')->toOptionArray($user),
                'required' => false,
                    )
            );
        }
