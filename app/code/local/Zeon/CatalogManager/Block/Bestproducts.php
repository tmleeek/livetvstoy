 ...
 */
class Zeon_CatalogManager_Block_Bestproducts
    extends Mage_Core_Block_Template
{
    ...
    public function getBestSellerProductCollection()
    {
        ...
        $isActive = Mage::getStoreConfig(
            'zeon_catalogmanager/best_products/active'
        );
    ...
    protected function _getProductCollection()
    {
        ...
        if (is_null($this->_productCollection)) {
            ...
            $collection->addAttributeToSelect(array('name', 'best_seller_position', 'small_image', 'product_flags'))
                ->addMinimalPrice()
                ->addFinalPrice()
                ->addTaxPercents()
                ->addAttributeToFilter('best_seller', 1, 'left')
                ->addStoreFilter();
            ...
            // Set best_seller_position the order-by clause.
            $collection->addAttributeToSort('best_seller_position', 'asc');
