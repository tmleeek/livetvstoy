 ...
 */
class Zeon_CatalogManager_Block_Adminhtml_Homepageoption3
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_homepageoption3';
        $this->_headerText =$helper->__('Homepage - Custom Option 3');

        $this->_removeButton('add');
        $this->_addButton(
            'save',
            array(
                'label'   => $helper->__('Save Homepage - Custom Option 3'),
    ...
    private function _prependHtml()
    {
    	...
    	<input name="form_key" type="hidden"
    		...
    		<div class="no-display">
        		<input type="hidden" name="homepage_option3" id="homepage_option3" value="" />
                <input type="hidden" name="homepage_option3_position" id="homepage_option3_position" value="" />
    		</div>
		</form>
    	';
