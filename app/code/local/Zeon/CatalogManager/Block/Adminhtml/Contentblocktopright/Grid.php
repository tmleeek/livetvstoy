 ...
 */
class Zeon_CatalogManager_Block_Adminhtml_Contentblocktopright_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setId('content_top_right_products');
        $this->setDefaultSort('entity_id');
        $this->setUseAjax(true);

        $this->setRowClickCallback('ContentTopRightClick');
    }
    ...
    protected function _prepareCollection()
    {
        ...
        if ($store->getId()||$store->getId() == 0 ) {
            ...
            $collection->joinAttribute(
                ...
                'catalog_product/content_top_right_position',
                'entity_id',
                null,
                'left',
                $store->getId()
            ...
            $collection->joinAttribute(
                'content_top_right',
                'catalog_product/content_top_right',
                'entity_id',
                null,
                'left',
                $store->getId()
        ...
        if (!$this->_isExport) {
            $this->addColumn(
                ...
                array(
                    ...
                    'width'     => '1',
                    'type'      => 'number',
                    'index'     => 'content_top_right_position',
    ...
    {
        return $this->getUrl('*/*/grid', array('_current' => true,'blockname'=>'adminhtml_contentblocktopright_grid'));
    }

    protected function _getSelectedProducts($json = false)
    {
        $temp = $this->getRequest()->getPost('gift_ids');
        $store = $this->_getStore();
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToFilter('content_top_right', '1');
    ...
    categoryForm = new varienForm('content_top_right_form');
    ...
    function handleGiftProductPositionBlur(event, element, trElement)
    {
        ...
        $("gift_products_position").value = textBoxes.toQueryString();

    }

    function isCheckboxChecked()
    {
        var everycheckbox = $$("#content_top_right_products_table tbody input.checkbox");
    ...
    {
        var everytextbox = $$("#content_top_right_products_table tbody input.input-text");
    ...
    {
        var params = {};
        var fields = $('content_top_right_form').getElementsBySelector(
            'input', 'select'
        );
    ...
    function ContentTopRightClick(grid, event)
    {
        isCheckboxChecked();
        setPositionValue();
        var trElement = Event.findElement(event, 'tr');
        ...
        $("gift_products").value = checkBoxes.toQueryString();

           $gridName.reloadParams = {'gift_products':checkBoxes.toQueryString()};
    }
...
EndHTML;
    ...
    private function _appendHtml()
    {
        ...
        var checkbox_all = $$("#content_top_right_products_table thead input.checkbox").
            first();
        var everycheckbox = $$("#content_top_right_products_table tbody input.checkbox");
