 ...
 */
class Zeon_CatalogManager_Block_Homepageoption3
    extends Mage_Core_Block_Template
{
     ...
     * @return Object
     */
    public function getHomepageOption3Collection()
    {
        // Check, whether the feature is enable or disabled.
        $isActive = Mage::getStoreConfig(
            'zeon_catalogmanager/homepage_products_option3/active'
        );
    ...
    protected function _getProductCollection()
    {
        ...
        if (is_null($this->_productCollection)) {
            ...
            $collection->addAttributeToSelect(array('name', 'homepage_option3_position', 'small_image'))
                ->addMinimalPrice()
                ->addFinalPrice()
                ->addTaxPercents()
            ...
            $collection->addAttributeToSort('homepage_option3_position', 'asc');
            ...
            $this->_productCollection = $collection;Mage::log((string)$collection->getSelect(), null, 'option3.log', true);
        }
