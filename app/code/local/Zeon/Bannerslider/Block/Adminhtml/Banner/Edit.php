...
class Zeon_Bannerslider_Block_Adminhtml_Banner_Edit
    extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton(
            'save',
            'label',
            Mage::helper('bannerslider')->__('Save Banner')
        );
        $this->_updateButton(
            'delete',
            'label',
            Mage::helper('bannerslider')->__('Delete Banner')
        );
    ...
    public function getHeaderText()
    {
        if ( Mage::registry('banner_data') &&
            ...
            return Mage::helper('bannerslider')
                ->__(
                    "Edit Banner '%s'",
