...
class Zeon_Newsletter_SubscriberController extends Mage_Newsletter_SubscriberController
{
    /**
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if ($subscriber && $subscriber->getSubscriberStatus() == '1') {
                    Mage::throwException($this->__('This email address already has an active subscription.'));
                }
