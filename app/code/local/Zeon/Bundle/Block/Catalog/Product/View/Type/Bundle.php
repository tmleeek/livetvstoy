 ...
 */
class Zeon_Bundle_Block_Catalog_Product_View_Type_Bundle extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle
{
    /**
    ...
    public function getJsonConfig()
    {
        ...
        foreach ($optionsArray as $_option) {
            ...
            $option = array (
                ...
                'isMulti'        => in_array($_option->getType(), array('multi', 'checkbox', 'partyplanner')),
                'isPartyPlanner' => ('partyplanner' == $_option->getType()) ? true : false, // Added By Zeon
                'subtitle'       => $_option->getSubtitle(), // Added By Zeon
                'position'       => $position++
            );
