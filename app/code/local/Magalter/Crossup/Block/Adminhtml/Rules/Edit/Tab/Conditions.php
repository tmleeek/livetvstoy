...
class Magalter_Crossup_Block_Adminhtml_Rules_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {      
       ...
       $upsell = Mage::registry('magalter_crossup_registry');
         ...
         $form->addFieldset('conditions_fieldset', array('legend' => $this->__('Related Products')))
    ...
    {
        return $this->getUrl('*/adminhtml_rules/conditions/form/rule_conditions_fieldset');
    }
