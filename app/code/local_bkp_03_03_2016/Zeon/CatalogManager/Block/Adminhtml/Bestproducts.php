 ...
 */
class Zeon_CatalogManager_Block_Adminhtml_Bestproducts
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_bestproducts';
        $this->_headerText = $helper->__('Best Seller Products');

        $this->_removeButton('add');
        $this->_addButton(
            'save',
            array(
                'label'   => $helper->__('Save Best Seller Products'),
    ...
    /**
     * Get the best seller product save url.
     *
     * @return url
     */
    ...
    {
        $html = '
    	<form id="best_edit_form" action="' . $this->getSaveUrl() . '"
            method="post" enctype="multipart/form-data">
    	<input name="form_key" type="hidden"
            value="' . $this->getFormKey() . '" />
    		<div class="no-display">
        		<input type="hidden" name="best_products" id="in_best_products" value="" />
                <input type="hidden" name="best_products_position" id="best_products_position" value="" />
    		</div>
		</form>
    	';
