...
class Celigo_Celigoconnector_Adminhtml_CeligoconnectorController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="indexAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $storeId = '';
        $websiteId = '';
        ...
        $result = Mage::helper('celigoconnector')->isValidateNetsuiteCredentials($storeId, $websiteId);
        if ($result === true) {
    ...
    public function resturlAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="resturlAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $storeId = '';
        $websiteId = '';
        $params = Mage::app()->getRequest()->getParams();
        unset($params['key']);
        ...
        // Fetch Rest URL
        $result = Mage::helper('celigoconnector')->fetchRestUrl($storeId, $websiteId);
        if ($result === true) {
    ...
    public function conflictsAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="conflictsAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $params = Mage::app()->getRequest()->getParams();
        unset($params['key']);
        // Fetch Rest URL
    ...
    public function cronrestartAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="cronrestartAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $params = Mage::app()->getRequest()->getParams();
        unset($params['key']);
    ...
    public function pushorderAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="pushorderAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $params = Mage::app()->getRequest()->getParams();
    ...
    public function cronondemandAction() {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="cronondemandAction started" class="Celigo_Celigoconnector_Adminhtml_CeligoconnectorController"', self::LOG_FILENAME);
        $params = Mage::app()->getRequest()->getParams();
        unset($params['key']);
        try {
            ...
            Mage::getModel('celigoconnector/cron')->pushOrdersToNs();
