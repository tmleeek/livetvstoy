    ...
    public function orderImportAction() {
        ...
        try {
            ...
            if (isset($data['orderIds'][0]) && trim($data['orderIds'][0]) != '') {
                ...
                Mage::helper('celigoconnector/celigologger')->info('infomsg="Setting payment info and starting sync call to pushOrderToNS." class="Celigo_Celigoconnector_AsyncController" record="order" recprdid=' . $orderIds, self::LOG_FILENAME);
