...
class Celigo_Celigoconnector_Model_Invoice_Api extends Mage_Sales_Model_Order_Invoice_Api {
    ...
    public function create($orderIncrementId, $itemsQty, $comment = null, $email = false, $includeComment = false) {
        Mage::helper('celigoconnector/celigologger')->info('infomsg="Inside Invoice.create" class="Celigo_Celigoconnector_Model_Invoice_Api"', self::LOG_FILENAME);
        ...
        try {
            ...
            Mage::helper('celigoconnector/celigologger')->error('errormsg="'.$e->getMessage().'", record="order" api="Invoice.create"', self::LOG_FILENAME);
