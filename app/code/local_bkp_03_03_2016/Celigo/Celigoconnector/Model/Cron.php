...
class Celigo_Celigoconnector_Model_Cron extends Mage_Core_Model_Abstract {
    ...
    public function pushOrdersToNs($schedule) {
        ...
        try {
            ...
            //$to = "celigoalerts@cpscompany.com";
            //$subject = "Email from Celigo cron Model";

            //$message = "This is an email alert from the script placed in Celigo cron Model function. ";
            ...
            // More headers
            //$headers .= 'From: <push_orders_to_ns@celigoconnector_cron.com>' . "\r\n";
