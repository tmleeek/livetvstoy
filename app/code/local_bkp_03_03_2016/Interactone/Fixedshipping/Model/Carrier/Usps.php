...
class Interactone_Fixedshipping_Model_Carrier_Usps
    extends Mage_Usa_Model_Shipping_Carrier_Usps
{
    ...
    {
        if (!Mage::helper('interactone_fixedshipping')->isUspsEnabled()) {
    ...
    protected function _updateFreeMethodQuote($request)
    {
        ...
        if (!Mage::helper('interactone_fixedshipping')->isUspsEnabled() || $fixedAmount === 0) {
