...
class Celigo_Celigoconnector_Model_Product_Api extends Mage_Catalog_Model_Product_Api {
        ...
        */
        ...
        if ($type == 'bundle') {
            ...
            try {
                ...
                Mage::helper('celigoconnector/celigologger')->error('errormsg="'.$e->getMeesage().'"'.' productId="' . $productId.'"', LOG_FILENAME);
            }
        }
    ...
    public function create($type, $set, $sku, $productData, $store = null) {
        ...
        */
        ...
        try {
            ...
            $this->logger->error('errormsg="'.$e->getMessage().'", record="product" api="product.create"', self::LOG_FILENAME);
    ...
    public function update($productId, $productData, $store = null, $identifierType = null) {
        $product = $this->_getProduct($productId, $store, $identifierType);
        if (!$product->getId()) {
            $this->logger->error('errormsg="No Product found with id "'.$productId.'", record="Product" api="Product.update"', self::LOG_FILENAME);
        ...
        */
        ...
        try {
            ...
            $this->logger->error('errormsg="'.$e->getMessage().'", record="Product" api="Product.update"', self::LOG_FILENAME);
            $this->_fault('data_invalid', $e->getMessage());
        }
