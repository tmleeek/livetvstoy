...
// Global Variables
global $designer_engine, $site_root, $site_url, $VAR_product_code, $AJAX_designer_VARS, $product_layers, $product_fields, $AJD_DB, $product_template, $material;
...
//$material = isset($material) ? $material : $_GET['metal'];

	/* STYLES */
	
	$scripts['css'][] = 'assets/lib/jqueryui/jquery-ui-1.9.1.custom.min.css';
	$scripts['css'][] = 'assets/css/main.css';
	$scripts['css'][] = 'assets/lib/fancybox/jquery.fancybox.css?v=2.1.5';
	...
	$scripts['js'][] = 'assets/lib/fancybox/jquery.fancybox.js?v=2.1.5';
...
//include('upload/func.php');						// Uploader functions
