...
<steps>
	...
	<step name="Step 2: Left View" to_js="true" replace_preview="3" merge_adjust="80">
		  ...
		  <layer type="text" font="Serifa BT" text_style="top_side_text" color="#dddddd" scolor="#555555" sdepth="4" width="250" height="300" top="32" left="25" size="24" side_pad="3" star_size="1" star_y="3" view_side="L" perspective="50" yscale="1.1" arc_args="1-180" mask="masks/S_upper.png"></layer>
          <layer>
              <option type="image" selector_label="CLIPART" comp_type="cliparts" init_value="1" cat_list="0-1-2-3-4-5-6-7" default="true" top="3" left="3" color="Grey" color_style="sigmodial" resize="0.5" mask="masks/S_lower.png"></option>
		  </layer>
	</step>
	<step name="Step 3: Right View" to_js="true" replace_preview="1" merge_adjust="90">
		  ...
		  <layer type="image" color="Black" value="stones/square2/SIDE_STONE.png" top="5" left="63" stone_style="colorized"></layer>
		  <layer type="text" font="Arial Black" text_style="arc2" color="#dddddd" talpha="1" scolor="#555555" salpha="1" sxoffset="0" syoffset="1" sdepth="1" width="94" height="20" fit="1" top="85" left="92" right="0" align="center" size="20" rotation="0" direction="CW" arc_args="1" yscale="1.4"></layer>
		  <layer type="text" font="Serifa BT" text_style="top_side_text" color="#dddddd" scolor="#555555" sdepth="4" width="250" height="300" top="32" left="25" size="24" side_pad="3" star_size="1" star_y="3" view_side="R" perspective="50" yscale="1.1" arc_args="1-180" mask="masks/S_upper.png"></layer>
          <layer>
              <option type="image" selector_label="CLIPART" comp_type="cliparts" init_value="1" cat_list="0-1-2-3-4-5-6-7" default="true" top="3" left="3" color="Grey" color_style="sigmodial" resize="0.5" mask="masks/S_lower.png"></option>
		  </layer>
	</step>
