...
*/
	...
	//$from_time = date("Y-m-d")." 05:00:01"; // UTC 05:00 is 12:00 CST
    $from_time = "2016-03-30 05:00:01";

    //$to_time = $date_to." 05:00:00";// UTC 05:00 is 12:00 CST. This needs to be changed when Day light savings changes
    $to_time = "2016-03-31 05:00:00";
	...
	$file = fopen(dirname(__FILE__) . "/spool/".$csv_file_name, "w");
