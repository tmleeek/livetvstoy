...
<steps>
	...
	<step name="Step 2: Left View" to_js="true" replace_preview="3" merge_adjust="80">
          ...
          <layer>
              <option type="image" selector_label="CLIPART" comp_type="cliparts" init_value="1" cat_list="0-1-2-3-4-5-6" default="true" top="5" left="4" color="Grey" color_style="sigmodial" resize="0.65" mask="masks/S_side.png"></option>
		  </layer>
	</step>
