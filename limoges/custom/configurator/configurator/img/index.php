...
global $core_width, $core_height, $designer_engine, $AJAX_designer_VARS, $mv_itm_rt, $mv_itm_y, $mv_itm_x, $mv_itm_rz;
...
$stepid = isset($_GET['stid']) ? $_GET['stid'] : NULL;
...
if((isset($_GET['SZ']) && $_GET['SZ'] == "P") && (isset($_GET['MP']) && $_GET['MP'] == "PF")) {
	...
	//$pidint = intval($id);
	//$g_name = md5($_COOKIE['frontend'].rand(1,$pidint)).'.'.$VAR_img_type;
