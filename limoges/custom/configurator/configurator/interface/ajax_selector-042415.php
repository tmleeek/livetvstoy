...
<div style="padding: 0 20px 10px 10px;">Select from the list of artwork below and click on <strong>BACK</strong>.</div>
        ...
        <?php if($com_type == 'wording'): ?>
            ...
            <?php foreach($arr_list as $a => $b): ?>
                ...
                <li class="<?php echo $com_type; ?> ">
                    <div class="selector-item <?php echo $showed; ?> " style="width: <?php if(count($arr_cats) > 1) :?>250px<?php else: ?>400px<?php endif; ?>;<?php if(isset($b['def'])) :?>border-color: red;<?php endif; ?>" title="<?php echo $b['title']; ?>" value="<?php echo $b['title']; ?>" <?php if($go_categorized) :?>cat_list="<?php echo $b['cat']; ?>"<?php endif; ?>>
...
<div class="selector-back-btn"><a href="#nogo" onclick="javascript: func_selector('close');">BACK</a></div>