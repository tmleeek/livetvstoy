...
<select required ajd_type="<?php echo $bf['type']; ?>" name="AJD_fields[<?php echo $af; ?>]" id="cbo-<?php echo $a.'-'.$af; ?>" onclick="javascript: tmb_focus('<?php echo $a; ?>');" onchange="javascript: <?php if($bf['type'] == 'metal'): ?>metal_update(this);<?php elseif($bf['type'] == 'stones') : ?>delayed_update(1);<?php endif; ?>" style="width: 260px;">
