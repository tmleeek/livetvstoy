...
<steps>
	<step name="Step 1: Top View" default_view="true" to_js="true" replace_preview="0">
		  ...
		  <layer type="text" font="Serifa BT" text_style="top_text_1" color="#dddddd" scolor="#555555" sdepth="8" width="194" height="218" top="22" left="39" size="60" side_pad="5" star_size="2.5" star_y="2" arc_top_rad="80" arc_bot_rad="62" rect="16"></layer>
		  <layer>
	...
	<step name="Step 2: Left View" to_js="true" replace_preview="3" merge_adjust="80">
		  ...
		  <layer type="text" font="Serifa BT" text_style="top_side_text" color="#dddddd" scolor="#555555" sdepth="4" width="250" height="300" top="38" left="22" size="32" side_pad="3" star_size="1.2" star_y="5" view_side="L" perspective="50" yscale="1" arc_args="5-180" mask="masks/S_upper.png"></layer>
          <layer>
              <option type="image" selector_label="CLIPART" comp_type="cliparts" init_value="1" cat_list="8-9-10-11-12" default="true" top="20" left="6" color="Grey" color_style="sigmodial" resize="0.65" mask="masks/S_lower.png"></option>
		  </layer>
	</step>
	<step name="Step 3: Right View" to_js="true" replace_preview="1" merge_adjust="90">
		  ...
		  <layer type="image" color="Black" value="stones/square3/SIDE_STONE.png" stone_style="colorized"></layer>
		  <layer type="text" font="Arial Black" text_style="arc2" color="#dddddd" talpha="1" scolor="#555555" salpha="1" sxoffset="0" syoffset="1" sdepth="1" width="132" height="42" fit="1" top="103" left="73" right="0" align="center" size="23" rotation="0" direction="CCW" arc_args="6-180" perspective="6" yscale="1.1" mask="masks/S_lower.png"></layer>
		  <layer type="text" font="Serifa BT" text_style="top_side_text" color="#dddddd" scolor="#555555" sdepth="5" width="250" height="300" top="38" left="22" size="32" side_pad="3" star_size="1.2" star_y="5" view_side="R" perspective="50" yscale="1" arc_args="5-180" mask="masks/S_upper.png"></layer>
          <layer>
              <option type="image" selector_label="CLIPART" comp_type="cliparts" init_value="1" cat_list="8-9-10-11-12" default="true" top="20" left="6" color="Grey" color_style="sigmodial" resize="0.65" mask="masks/S_lower.png"></option>
		  </layer>
	</step>
