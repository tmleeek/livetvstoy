...
<steps>
	<step name="Step 1: Front Side" default_view="true" to_js="true" replace_preview="0">
          ...
          <layer type="text" font="GhostKid AOE" text_style="text2" color="#2ba8e6" talpha="1" width="150" height="50" fit="1" top="385" left="0" align="center" size="20" rotation="0" direction="CCW" arc_args="1-180" perspective="6" yscale="1.1"></layer>
	</step>
</steps>
EOT;
?>
