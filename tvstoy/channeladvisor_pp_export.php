<?php
    ...
    if ($profile->run_status == "finished"){
        ...
        $message = "Channel Advisor Personalized Planet Product Export began at $profile_start and ceased at $profile_finish. For more information visit https://admin.tystoybox.com/index.php/urapidflowadmin/adminhtml_profile/edit/id/71";
        ...
        $subject = "Channel Advisor PP Product Export Notification"; //subject
