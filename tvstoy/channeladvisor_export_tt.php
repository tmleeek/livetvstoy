<?php
    ...
    if ($profile->run_status == "finished"){
        ...
        $message = "Channel Advisor Product Export Tystoybox began at $profile_start and ceased at $profile_finish. For more information visit https://admin.tystoybox.com/index.php/urapidflowadmin/adminhtml_profile/edit/id/217";
