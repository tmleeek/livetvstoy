...
class SFC_Kount_PaypalstandardController extends Mage_Core_Controller_Front_Action
{
    ...
    public function redirectAction()
    {
        try {
            ...
            if (Mage::getStoreConfig('kount/account/enabled') && Mage::getStoreConfig('kount/workflow/workflow_mode') == SFC_Kount_Model_Source_WorkflowMode::MODE_PRE_AUTH) {
    ...
    public function cancelAction()
    {
        try {
            ...
            // Is Kount enabled and configured
            if (Mage::getStoreConfig('kount/account/enabled') && $helper->validateConfig()) {
