...
<style>
	...
	.product-essential .prod-detail-right::before{
		border-left: none;
	}
	a#designerFormSubmit{
	...
	a#designerFormSubmit:hover, a#designerFormSubmit:active, a#designerFormSubmit:focus{
		background-color: #f47421;
	}
</style>
<div>
						...
						<div id="cart-button-div-id-cl" class="<?php if(isset($classToAdd)) echo $classToAdd; ?>">
							<div class="step-button-holder">
								<div class="step-button button btn-cart red-button" onclick="submit_form();" style="display:none;">Add to Cart</div>
									...
									<a href="#" id="designerFormSubmit" class="js-add-to-cart js-flyout-toggle js-btn-progress add-to-cart btn btn-primary btn-stacked btn-block">Add to Cart</a>
