...
<fields>
	  ...
	  <fields type="text" default="Love You Always" label="Inside Engraving" assoc_step_group="0" assoc_step="0" assoc_layers="1" selector_type="text" chars="titlecase"></fields>
</fields>
EOT;
?>