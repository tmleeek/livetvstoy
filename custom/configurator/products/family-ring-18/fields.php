...
<fields>
	  ...
	  <fields type="textd" default="Liz" label="Front Text 1" assoc_step_group="0" assoc_step="0" assoc_layers="7" selector_type="text" chars="namecase"></fields>
      ...
      <fields type="textd" default="John" label="Front Text 2" assoc_step_group="0" assoc_step="0" assoc_layers="8" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Patrick" label="Front Text 3" assoc_step_group="0" assoc_step="0" assoc_layers="9" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Andrew" label="Front Text 4" assoc_step_group="0" assoc_step="0" assoc_layers="10" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Michael" label="Front Text 5" assoc_step_group="0" assoc_step="0" assoc_layers="11" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Rachel" label="Front Text 6" assoc_step_group="0" assoc_step="0" assoc_layers="12" selector_type="text" chars="namecase"></fields>
