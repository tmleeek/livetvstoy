...
<fields>
	  ...
	  <fields type="textd" default="Melissa" label="Front Text 1" assoc_step_group="0" assoc_step="0" assoc_layers="6" selector_type="text" chars="namecase"></fields>
      ...
      <fields type="textd" default="Erica" label="Front Text 2" assoc_step_group="0" assoc_step="0" assoc_layers="7" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Rachel" label="Front Text 3" assoc_step_group="0" assoc_step="0" assoc_layers="8" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Monica" label="Front Text 4" assoc_step_group="0" assoc_step="0" assoc_layers="9" selector_type="text" chars="namecase"></fields>
	  ...
	  <fields type="textd" default="Victoria" label="Front Text 5" assoc_step_group="0" assoc_step="0" assoc_layers="10" selector_type="text" chars="namecase"></fields>
