...
<fields>
	  ...
	  <fields type="text" default="Jonathan" label="Left Engraving" assoc_step_group="0" assoc_step="0" assoc_layers="3" selector_type="text" chars="namecase"></fields>
      ...
      <fields type="text" default="Samantha" label="Right Engraving" assoc_step_group="0" assoc_step="0" assoc_layers="4" selector_type="text" chars="namecase"></fields>
