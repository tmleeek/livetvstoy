...
<steps>
	<step name="Step 1: Front Side" default_view="true" to_js="true" replace_preview="0">
          ...
          <layer type="image" value="stones/couples-ring-26/FRONT_STONE1.png" top="0" left="0" stone_style="colorized"></layer>
          <layer type="image" value="stones/couples-ring-26/FRONT_STONE2.png" top="0" left="0" stone_style="colorized"></layer>
	</step>
</steps>
EOT;
?>
