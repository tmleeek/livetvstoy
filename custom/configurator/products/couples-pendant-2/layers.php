...
<steps>
	<step name="Step 1: Front Side" default_view="true" to_js="true" replace_preview="0">
          ...
          sxoffset="-1" syoffset="-1" sdepth="1" usecolor="true" stroke="true" strokecolor="#ffffff" strokewidth="1" width="120" height="12" top="280" left="113" align="center" size="12" rotation="0" direction="CCW" arc_args="35-188" perspective="1" xscale="0.7" yscale="1" skewx="0" mask="masks/F_right.png"></layer>
	</step>
</steps>
EOT;
?>
