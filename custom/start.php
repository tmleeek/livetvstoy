...
include  __DIR__.'/configurator/custom.php';			// Custom functions specialized for the current platform
include  __DIR__.'/configurator/func_common.php';		// Common functions
include  __DIR__.'/configurator/session.php';			// Session functions
