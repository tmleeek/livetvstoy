...
class Kwanso_Apiaddtocart_CartController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function updateItemOptionsAction()
    {
        ...
        try {
            ...
            /*Custom call should be remove later*/
            Mage::dispatchEvent(
                'kwanso_cart_update_options_to_api',
                array(
                  'product' => $id, 
                  'options' => serialize($params['options']),
                  'quote'   => Mage::getSingleton('adminhtml/session_quote')->getQuote()->getId(),
