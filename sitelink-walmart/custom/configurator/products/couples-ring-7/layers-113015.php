...
<steps>
	<step name="Step 1: Front Side" default_view="true" to_js="true" replace_preview="0">
          ...
          sxoffset="1" 
          syoffset="1" 
          sdepth="1" usecolor="true" width="95" height="10" top="68" left="-6" align="center" size="10" rotation="0" direction="CW" arc_args="50-315" perspective="1" xscale="0.7" yscale="1.2" skewx="15" mask="masks/F_left.png"></layer>
          <layer type="text" 
          font="Arial" 
          text_style="arcnew1" 
          ucolor="#000000" 
          ...
          sxoffset="1" 
          syoffset="1" 
          sdepth="1" usecolor="true" width="95" height="10" top="138" left="237" align="center" size="10" rotation="0" direction="CW" arc_args="60-30" perspective="1" xscale="0.7" yscale="1.2" skewx="0" mask="masks/F_right.png"></layer>
	</step>
</steps>
EOT;
?>
