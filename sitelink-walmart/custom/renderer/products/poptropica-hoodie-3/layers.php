...
<steps>
	<step name="Step 1: Front Side" default_view="true" to_js="true" replace_preview="0">
          ...
          <layer type="avatar" value="/samples/1468_www250_836842470.png" bottom="212" left="250" right="235" resize="0.165"></layer>
          <layer type="text" font="GhostKid AOE" text_style="text2" color="#f25f95" talpha="1" width="150" height="50" fit="1" top="400" left="0" align="center" size="14"></layer>
	</step>
</steps>
EOT;
?>
