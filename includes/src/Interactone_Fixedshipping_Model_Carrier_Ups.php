...
class Interactone_Fixedshipping_Model_Carrier_Ups
    extends Mage_Usa_Model_Shipping_Carrier_Ups
{
    ...
    {
        if (!Mage::helper('interactone_fixedshipping')->isUpsEnabled()) {
    ...
    protected function _updateFreeMethodQuote($request)
    {
        ...
        if (!Mage::helper('interactone_fixedshipping')->isUpsEnabled() || $fixedAmount === 0) {
