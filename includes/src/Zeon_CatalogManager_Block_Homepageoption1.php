 ...
 */
class Zeon_CatalogManager_Block_Homepageoption1
    extends Mage_Core_Block_Template
{
     ...
     * @return Object
     */
    public function getHomepageOption1Collection()
    {
        // Check, whether the feature is enable or disabled.
        $isActive = Mage::getStoreConfig(
            'zeon_catalogmanager/homepage_products_option1/active'
        );
    ...
    protected function _getProductCollection()
    {
        ...
        if (is_null($this->_productCollection)) {
            ...
            $collection->addAttributeToSelect(array('name', 'homepage_option1_position', 'small_image'))
                ->addMinimalPrice()
                ->addFinalPrice()
                ->addTaxPercents()
                ->addAttributeToFilter('homepage_option1', 1, 'left')
                ->addStoreFilter();
            ...
            $collection->addAttributeToSort('homepage_option1_position', 'asc');
