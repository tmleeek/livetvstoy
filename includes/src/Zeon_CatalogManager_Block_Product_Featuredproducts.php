 ...
 */
class Zeon_CatalogManager_Block_Product_Featuredproducts
    extends Mage_Catalog_Block_Product_List
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $toolbar->addOrderToAvailableOrders(
            'best',
            Mage::helper('zeon_catalogmanager')->__('Best Seller')
        );
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
            $order = $this->getRequest()->getParam('order', 'featured_product');
