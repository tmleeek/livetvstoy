 ...
 */
class Zeon_CatalogManager_Block_Adminhtml_Homepageoption2_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setId('homepage_option2_grid');
        $this->setDefaultSort('entity_id');
        $this->setUseAjax(true);

        $this->setRowClickCallback('HomepageOption2Click');
    }
    ...
    protected function _prepareCollection()
    {
        ...
        if ($store->getId()||$store->getId() == 0 ) {
            ...
            $collection->joinAttribute(
                'homepage_option2_position',
                'catalog_product/homepage_option2_position',
                'entity_id',
                null,
                'left',
                $store->getId()
            ...
            $collection->joinAttribute(
                'homepage_option2',
                'catalog_product/homepage_option2',
                'entity_id',
                null,
                'left',
                $store->getId()
    ...
    protected function _prepareColumns()
    {
        ...
        if ($actionName != 'exportCsv' && $actionName != 'exportXml') {
Mage::log(print_r($this->_getSelectedProducts(),1));
            $this->addColumn(
                'product_options',
                array(
        ...
        if (!$this->_isExport) {
            $this->addColumn(
                ...
                array(
                    ...
                    'width'     => '1',
                    'type'      => 'number',
                    'index'     => 'homepage_option2_position',
    ...
    {
        return $this->getUrl('*/*/grid', array('_current' => true,'blockname'=>'adminhtml_homepageoption2_grid'));
    }

    protected function _getSelectedProducts($json = false)
    {
        $temp = $this->getRequest()->getPost('homepage_option2');
        $store = $this->_getStore();
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToFilter('homepage_option2', '1');
    ...
    function handleGiftProductPositionBlur(event, element, trElement)
    {
        ...
        $("homepage_option2_position").value = textBoxes.toQueryString();

    }

    function isCheckboxChecked()
    {
        var everycheckbox = $$("#homepage_option2_grid_table tbody input.checkbox");
    ...
    {
        var everytextbox = $$("#homepage_option2_grid_table tbody input.input-text");
    ...
    function HomepageOption2Click(grid, event)
    {
        isCheckboxChecked();
        setPositionValue();
        var trElement = Event.findElement(event, 'tr');
        ...
        $("homepage_option2").value = checkBoxes.toQueryString();

           $gridName.reloadParams = {'homepage_option2':checkBoxes.toQueryString()};
    }
...
EndHTML;
    ...
    private function _appendHtml()
    {
        ...
        var checkbox_all = $$("#homepage_option2_grid_table thead input.checkbox").
            first();
        var everycheckbox = $$("#homepage_option2_grid_table tbody input.checkbox");
