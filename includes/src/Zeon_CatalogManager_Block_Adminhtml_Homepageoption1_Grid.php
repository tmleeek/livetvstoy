 ...
 */
class Zeon_CatalogManager_Block_Adminhtml_Homepageoption1_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setId('homepage_option1_grid');
        $this->setDefaultSort('entity_id');
        $this->setUseAjax(true);

        $this->setRowClickCallback('HomepageOption1Click');
    }
    ...
    protected function _prepareCollection()
    {
        ...
        if ($store->getId()||$store->getId() == 0 ) {
            ...
            $collection->joinAttribute(
                'homepage_option1_position',
                'catalog_product/homepage_option1_position',
                'entity_id',
                null,
                'left',
                $store->getId()
            ...
            $collection->joinAttribute(
                'homepage_option1',
                'catalog_product/homepage_option1',
                'entity_id',
                null,
                'left',
                $store->getId()
        ...
        if (!$this->_isExport) {
            $this->addColumn(
                ...
                array(
                    ...
                    'width'     => '1',
                    'type'      => 'number',
                    'index'     => 'homepage_option1_position',
    ...
    {
        return $this->getUrl('*/*/grid', array('_current' => true,'blockname'=>'adminhtml_homepageoption1_grid'));
    }

    protected function _getSelectedProducts($json = false)
    {
        $temp = $this->getRequest()->getPost('homepage_option1');
        $store = $this->_getStore();
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToFilter('homepage_option1', '1');
    ...
    function handleGiftProductPositionBlur(event, element, trElement)
    {
        ...
        $("homepage_option1_position").value = textBoxes.toQueryString();

    }

    function isCheckboxChecked()
    {
        var everycheckbox = $$("#homepage_option1_grid_table tbody input.checkbox");
    ...
    {
        var everytextbox = $$("#homepage_option1_grid_table tbody input.input-text");
    ...
    function HomepageOption1Click(grid, event)
    {
        isCheckboxChecked();
        setPositionValue();
        var trElement = Event.findElement(event, 'tr');
        ...
        $("homepage_option1").value = checkBoxes.toQueryString();

           $gridName.reloadParams = {'homepage_option1':checkBoxes.toQueryString()};
    }
...
EndHTML;
    ...
    private function _appendHtml()
    {
        ...
        var checkbox_all = $$("#homepage_option1_grid_table thead input.checkbox").
            first();
        var everycheckbox = $$("#homepage_option1_grid_table tbody input.checkbox");
