 ...
 */
class Zeon_Sales_Model_Order_Shipment_Api_V2
    extends Zeon_Sales_Model_Order_Shipment_Api
{
    ...
    protected function _prepareItemQtyData($data)
    {
        ...
        foreach ($data as $item) {
            if (isset($item->$orderItemId) && isset($item->qty)) {
                $_data[$item->$orderItemId] = $item->qty;
            }
        }
        return $_data;
    }
