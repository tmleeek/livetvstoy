 ...
 */
class Zeon_CatalogManager_Block_Product_Productpageoption1
    extends Mage_Catalog_Block_Product_List
{
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
            $order = $this->getRequest()->getParam('order', 'homepage_option1_position');
     ...
     */
    public function getHomeOption1ProductCollection()
    {
