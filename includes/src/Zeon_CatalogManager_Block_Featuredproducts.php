 ...
 */
class Zeon_CatalogManager_Block_Featuredproducts
    extends Mage_Core_Block_Template
{
    ...
    public function getFeaturedProductCollection()
    {
        ...
        $isActive = Mage::getStoreConfig(
            'zeon_catalogmanager/featured_products/active'
        );
    ...
    protected function _getProductCollection()
    {
        ...
        if (is_null($this->_productCollection)) {
            ...
            $collection->addAttributeToSelect(array('name', 'featured_product_position', 'small_image'))
                ->addMinimalPrice()
                ->addFinalPrice()
                ->addTaxPercents()
            ...
            // Set the featured_product_position order-by clause.
            $collection->addAttributeToSort('featured_product_position', 'asc');

            // Set the page limit.
            $configSettings = Mage::helper('zeon_catalogmanager')->getConfigDetails('featured_products');
            $collection->setPageSize($configSettings['number_of_items']);
            // Set the collection to a var.
            $this->_productCollection = $collection;
        }

        // Return the featured product collection.
