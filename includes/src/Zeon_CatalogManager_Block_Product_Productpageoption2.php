 ...
 */
class Zeon_CatalogManager_Block_Product_Productpageoption2
 ...
 */
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
            $order = $this->getRequest()->getParam('order', 'homepage_option2_position');
     ...
     */
    public function getHomeOption2ProductCollection()
    {
