    ...
    implements Mana_Filters_Interface_Filter
{
    ...
    protected function _getItemsData()
    {
        ...
        $activeAttributeData = array();
        if (class_exists("Zeon_Attributemapping_Model_Attributemapping",false)) {
        	$activeAttributeData = Mage::getModel('zeon_attributemapping/attributemapping')
        		->getActiveAttributes($attribute);
        }
        ...
        if ($data === null) {
            if ($query->isOptimizedAttributeFilter($this)) {
                ...
                foreach ($options as $option) {
                    ...
                    if (!in_array($option['value'], $activeAttributeData)) {
                        continue;
                    }
