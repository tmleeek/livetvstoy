...
class Interactone_Fixedshipping_Model_Carrier_Productmatrix
    extends Webshopapps_Productmatrix_Model_Carrier_Productmatrix
{
    ...
    {
        if (!Mage::helper('interactone_fixedshipping')->isProductmatrixEnabled()) {
    ...
    protected function _updateFreeMethodQuote($request)
    {
        ...
        if (!Mage::helper('interactone_fixedshipping')->isProductmatrixEnabled() || $fixedAmount === 0) {
