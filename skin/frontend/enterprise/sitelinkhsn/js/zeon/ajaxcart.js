...
AjaxCart.prototype = {
    ...
    addUpdate : function(postUrl, thisObj) {
        ...
        if (allsetType) {
		    ...
		    document.domain = 'hsn.com';
		    window.parent.PostBack(tocken);
		    //window.parent.window.HSN.Instance().GetAddtoBagModal().Show(false, 0, 0, 0, pid, 1, 1, '', '', '', '', tocken, '', null, null, null, '/bag/modal', null, 0);
