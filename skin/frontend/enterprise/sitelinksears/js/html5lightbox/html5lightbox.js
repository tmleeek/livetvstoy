    ...
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            inst.options = jQuery.extend({
                ...
                fadespeed: 400,
                jsfolder: jsFolder,
                skinsfoldername: SKIN_URL + "frontend/enterprise/limoges/images/",
                ...
                titlecss: "{color:#333; font-size:16px; overflow:hidden; }",
                errorwidth: 280,
                errorheight: 48,
            ...
            var ELEM_TYPE = 0,
                ...
                ELEM_HREF_WEBM = 6,
                ELEM_HREF_OGG = 7,
				/*BO : code added to show the static block*/
				CONTENT_ID = 8;
				/*EFO : code added to show the static block*/
            inst.readData = function () {
                inst.each(function () {
                    ...
                    inst.elemArray.push(new Array(fileType,
                        $this.attr("href"), $this.attr("title"), $this.data("group"), $this.data("width"), $this.data("height"), $this.data("webm"), $this.data("ogg"),$this.attr("id")))
                })
            };
            inst.createMarkup = function () {
                ...
                inst.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + inst.options.overlaybgcolor + ";opacity:" + inst.options.overlayopacity + ";filter:alpha(opacity=" +
                    ...
                    inst.options.skinsfolder + inst.options.loadingimage + "\") no-repeat center center;'></div>" + "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + inst.options.bordersize + "px;text-align:center;width:" + inst.options.errorwidth + "px;height:" + inst.options.errorheight + "px;'>" + "The requested content cannot be loaded.<br />Please try again later." + "</div>" + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + inst.options.bordersize + "px;text-align:center;border: 5px solid #ebebeb;background:#fff;'>This is for test</div>" +
            ...
            inst.showTitle = function (w, t) {
                ...
                inst.resizeLightbox(sizeObj.w, sizeObj.h, true, function () {
					...
					var imageData  = "<img src='" + elem[ELEM_HREF] + "' width='" + sizeObj.w + "' height='" + sizeObj.h + "' />";
					/*BO : code added to show the static block*/
					try {
						if(elem[CONTENT_ID]){
						    var container = elem[CONTENT_ID];
						    imageData = imageData + $('.'+container).html();
						}
					} catch(err){
						return false;
					}					
					/*EO : code added to show the static block*/
                    inst.$image.html(imageData);
