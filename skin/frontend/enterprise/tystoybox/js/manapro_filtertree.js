...
;(function($) {
    ...
    $(document).bind('m-ajax-after', function (e, selectors, productsClicked) {
        _loadState();
        jQuery('ol#m-tree-left_category').children('li:not(.m-selected-ln-item)').children('ul').hide();
        jQuery('ol#m-tree-left_category').children('li:not(.m-selected-ln-item)').removeClass('m-expanded').addClass('m-collapsed');

        // jQuery('.m-filter-item-list').children('li').addClass('m-expanded');
        // jQuery('.m-filter-item-list').children('li').children('ul').parent('li').removeClass('m-expanded').addClass('m-collapsed');
        // jQuery('.m-filter-item-list').children('li').children('ul').hide();
        // //display selected category section open
        jQuery('ol#m-tree-left_category').children('li').children('ul').find('li.m-selected-ln-item').parent('ul').show();
        jQuery('ol#m-tree-left_category').children('li').children('ul').find('li.m-selected-ln-item').parent('ul').parent('li').removeClass('m-collapsed').addClass('m-expanded');
    });
})(jQuery);