<?php
    ...
    if ($profile->run_status == "finished"){
        ...
        $message = $profile_name. "began at $profile_start and ceased at $profile_finish. For more information visit https://admin.tystoybox.com/index.php/urapidflowadmin/adminhtml_profile/edit/id/290";


        $Name = "Admin"; //senders name
        $email = "admin@tvstoybox.com"; //senders e-mail adress
