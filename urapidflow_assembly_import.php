<?php
	...
	$profile_start = date('Y-m-d h:i:s A', strtotime($profile->started_at) - 60 * 60 * 5);
        ...
        $message = $profile_name. " began at $profile_start and ceased at $profile_finish. For more information visit https://admin.tystoybox.com/index.php/urapidflowadmin/adminhtml_profile/edit/id/45";


        $Name = "Admin"; //senders name
        $email = "admin@tystoybox.com"; //senders e-mail adress
        $recipient = "CKettman@cpscompany.com"; //recipient
